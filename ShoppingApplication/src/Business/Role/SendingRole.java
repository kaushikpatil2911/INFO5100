...
import userinterface.SendingRole.SendingWorkAreaJPanel;

/**
 *
 * @author Kaushik
 */
public class SendingRole extends Role {
    ...
    public JPanel createWorkArea(JPanel userProcessContainer, UserAccount account, Organization organization, Enterprise enterprise, EnterpriseDirectory enterpriseDirectory, EcoSystem business) {
        return new SendingWorkAreaJPanel(userProcessContainer, organization, account, (DeliveryPlatformEnterprise)enterprise);
    }
}
